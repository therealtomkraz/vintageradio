...
- [x] **Mechanical Sleep Timer**: Introduce a rotating countdown dial (e.g., 15, 30, 60 minutes) that smoothly attenuates the `masterVolume` to 0% and triggers the `I/O` shutdown sequence to assist users falling asleep without jolting them awake.
